...
#section(
    ...
    subSection(
        ...
        align(center, table(
            ...
            [Coherence], [Is used to refer to the ability of a system to be coherent, that is, ensuring the uniformity of shared resources across the entire system. In particular, it ensures that the order of accesses to a single memory location is observed by all of the actors within the system.],
